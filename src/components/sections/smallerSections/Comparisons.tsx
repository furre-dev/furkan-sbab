...
export default function Comparisons({ comparisons, loanAmount, binding_period, mortgage_rate }: {
  ...
  return (
    <>
      ...
      <ul className="flex mt-6 space-x-5 pb-4 px-4 overflow-scroll relative
      ...
      [&::-webkit-scrollbar-thumb]:bg-gray-300
        ...
        ref={ref}
      >
        {banks_array.length > 0 ? banks_array : <p>Det finns inga banker att jämföra med för denna bindningstid. Välj en annan bindningstid för att se jämförelser.</p>}
      </ul>
    </>
  )
}